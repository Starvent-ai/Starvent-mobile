    ...
    <div>
      <div className="card">
        ...
        <p style={{ color: "var(--sv-text-600)", marginTop: 0 }}>
          این بخش برای مدیریت کاربران و ثبت لاگ فعالیت است؛ ورود به این بخش، دسترسی شما به بقیهٔ
          برنامه را محدود نمی‌کند — برای اینکه در همین مرحله از توسعه، تست کردن بقیهٔ ماژول‌ها راحت
          بمونه.
        </p>
        {currentUser ? (
          <div>
