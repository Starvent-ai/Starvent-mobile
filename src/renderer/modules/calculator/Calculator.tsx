    ...
    <div>
      <div className="card no-print">
        ...
        <div className="form-row">
          <div>
            <label htmlFor="calc-purchase">قیمت خرید (تومان)</label>
            <input id="calc-purchase" type="number" min={0} value={purchasePrice} onChange={(e) => setPurchasePrice(e.target.value)} />
          </div>
          <div>
            <label htmlFor="calc-sale">قیمت فروش (تومان)</label>
            <input id="calc-sale" type="number" min={0} value={salePrice} onChange={(e) => setSalePrice(e.target.value)} />
          </div>
          <div>
          ...
          <div>
            ...
            <input id="calc-discount-value" type="number" min={0} value={discountValue} onChange={(e) => setDiscountValue(e.target.value)} />
          </div>
        </div>
        <div className="form-row">
          <div>
